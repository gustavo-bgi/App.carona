...
async function carregarDados() {
    ...
    try {
        ...
        // Sincroniza saldos com o mês em tela
...
function configurarInterface() {
    ...
    // Bloqueio de Motorista como Passageiro
...
// Funções de salvamento e lógicas auxiliares permanecem as mesmas (salvarViagem, salvarPessoa, fecharMes...)
// [Insira aqui as funções salvarViagem, salvarPessoa, salvarConfig, popularSelect, fecharMes, etc do código anterior]
